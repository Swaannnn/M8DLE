...
const toOrgPlayerForms = (player?: Player | null): OrgPlayerForm[] =>
 ...
 * de sortie terminée) : les champs repartent des valeurs de `player` à chaque ouverture, sans
...
function PlayerFormContent({ onClose, player, onSuccess }: Omit<PlayerFormProps, 'open'>) {
    ...
    const [orgPlayers, setOrgPlayers] = useState<OrgPlayerForm[]>(() => toOrgPlayerForms(player))
    ...
    return (
        <>
            <Dialog.Header>
                <Dialog.Title fontSize="2xl">{player ? t('editPlayer') : t('addPlayer')}</Dialog.Title>
            </Dialog.Header>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <CustomDatePicker
                                                required
                                                value={op.start}
                                                onChange={(val) => updateOrg(i, 'start', val || '')}
                                            />
                                        </VStack>
                                        <VStack
                                            align="stretch"
                                        ...
                                        >
                                            ...
                                            <CustomDatePicker
                                                value={op.end || null}
                                                onChange={(val) => updateOrg(i, 'end', val)}
                                            />
                                        </VStack>
                                        <IconButton
                                            variant="outline"
